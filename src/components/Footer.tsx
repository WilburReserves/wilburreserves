    ...
    <footer aria-labelledby="footer-heading" className="bg-black py-16">
      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-10 md:grid-cols-3">
          <NavGroup title="Shop">
            <NavLink href="/fragrance/terra">Oba&apos;s Ember</NavLink>
            <NavLink href="/fragrance/igni">Odogwu&apos;s Ember</NavLink>
            <NavLink href="/fragrance/aqua">The Emir</NavLink>
          </NavGroup>

          <NavGroup title="About">
            <NavLink href="#">Science</NavLink>
            <NavLink href="#">Our Story</NavLink>
            <NavLink href="#">The Royal Collection</NavLink>
          </NavGroup>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-neutral-800 pt-8 md:flex-row">
          <p className="text-center text-sm text-gray-400">
            © {new Date().getFullYear()} Wilbur Reserves & Brewery Ltd. All rights reserved
          </p>
          <TransitionLink
            href="/"
